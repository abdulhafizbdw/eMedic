...
export const SideNav = (props) => {
	return (
		<div className="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" className="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-primary-100 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
			<div className="flex items-center justify-center mt-8">
				<div className="flex items-center">
					...
					<span className="text-white text-2xl mx-2 font-semibold">eMedic</span>
				</div>
			</div>

			<nav className="mt-10">
				<a className="flex items-center mt-4 py-2 px-6 border-l-4 bg-gray-600 bg-opacity-25 text-gray-100 border-gray-100" href="/dashboard">
				...
				<a className="flex items-center mt-4 py-2 px-6 border-l-4 border-primary-100 text-white hover:bg-gray-600 hover:bg-opacity-25 hover:text-gray-100" href="/service">
					<svg className="h-5 w-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<a className="flex items-center mt-4 py-2 px-6 border-l-4 border-primary-100 text-white hover:bg-gray-600 hover:bg-opacity-25 hover:text-gray-100" href="/professional">
					<svg className="h-5 w-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<span className="mx-4">Health Records</span>
				</a>

				<a className="flex items-center mt-4 py-2 px-6 border-l-4 border-primary-100 text-white hover:bg-gray-600 hover:bg-opacity-25 hover:text-gray-100" href="/addservice">
					...
					<span className="mx-4">Appointment</span>
				</a>
			</nav>
		</div>
	);
