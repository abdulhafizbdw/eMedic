		...
		<header className="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-indigo-600">
			...
			<div className="flex items-center">
				...
				<div className="relative">
					<button onClick={() => setOpen(!open)} click="dropdownOpen = !dropdownOpen" className="relative z-10 block h-8 w-8 rounded-full overflow-hidden shadow focus:outline-none">
